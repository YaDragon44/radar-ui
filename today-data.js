...
window.RADAR_PORTFOLIO = [
  {
    ...
    "portfolio":{"value_rub":114005,"cash_rub":1564,"contributed_rub":141000,"dividends_rub":7979,"drawdown_rub":27285,"week":141,"positions":[["Артген","20"],["Астра","60"],["ВК","38"],["М.Видео","5"],["Мечел","6"],["ММК","270"],["НМТП","2 200"],["Новатэк","28"],["Роснефть","50"],["Россети","280 000"],["ТГК-1","600 000"],["ЦИАН","9"],["Фонд Тинькофф Индекс Мосбиржи","44 лота"]],"last_operation":null,"source_target":null,"source_targets":{"NVTK":{"target_price_rub":1400,"semantic_class":"SOURCE_TARGET","status":"CONFIRMED_LATEST","note":"Последняя подтверждённая цель; заменяет более раннюю цель 2000 ₽"},"ROSN":{"target_price_rub":600,"semantic_class":"SOURCE_TARGET","status":"CONFIRMED"},"ASTR":{"target_price_rub":300,"semantic_class":"SOURCE_TARGET","status":"CONFIRMED"},"CNRU":{"target_price_rub":1000,"semantic_class":"SOURCE_TARGET","status":"CONFIRMED"},"NMTP":{"target_price_rub":11,"semantic_class":"SOURCE_TARGET","status":"CONFIRMED"},"FEES":{"target_price_rub":0.12,"semantic_class":"SOURCE_TARGET","status":"CONFIRMED"},"TGKA":{"target_price_rub":0.012,"semantic_class":"SOURCE_TARGET","status":"CONFIRMED"}}}
  },
  {
